...
//OPERADOR LÓGICO DE NEGAÇÃO ! - O operador !, nega uma operação booleana. Ou seja, !true é igual a false. Dica, você pode utilizar o !! para verificar se uma expressão é Truthy ou Falsy.
// Truthy
if(!true) // false
if(!1) // false
if(!'') // true
...
//OPERADORES LÓGICOS || - ompara se uma expressão ou outra é verdadeira. Retorna o primeiro valor true que encontrar.
true || true; // true
true || false; // true
false || true; // true
'Gato' || 'Cão'; // 'Gato'
